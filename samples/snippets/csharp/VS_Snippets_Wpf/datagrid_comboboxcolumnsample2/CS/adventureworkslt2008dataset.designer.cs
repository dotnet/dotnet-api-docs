...
namespace ComboBoxColumnSample2.AdventureWorksLT2008DataSetTableAdapters {
...
SELECT CustomerID, NameStyle, Title, FirstName COLLATE SQL_Latin1_General_CP1_CI_AS AS Expr1, MiddleName COLLATE SQL_Latin1_General_CP1_CI_AS AS Expr2, LastName COLLATE SQL_Latin1_General_CP1_CI_AS AS Expr3, Suffix, CompanyName, SalesPerson, EmailAddress, Phone COLLATE SQL_Latin1_General_CP1_CI_AS AS Expr4, PasswordHash, PasswordSalt, rowguid, ModifiedDate FROM SalesLT.Customer WHERE (CustomerID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = ComboBoxColumnSample2.Properties.Settings.Default.AdventureWorksLT2008ConnectionString;
        }
