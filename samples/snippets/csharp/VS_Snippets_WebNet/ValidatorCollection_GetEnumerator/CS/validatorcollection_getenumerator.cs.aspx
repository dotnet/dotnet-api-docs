...
-->
   ...
   <body>
      ...
      <asp:Label id="Label4" Height="19px" Width="337px" Font-Size="Medium" Font-Bold="True" 
        style="LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server">ValidatorCollection Example:
      </asp:Label>
      ...
      <asp:Label id="Label3" runat="server" ForeColor="Red" 
        style="LEFT: 262px;POSITION: absolute; TOP: 86px">*</asp:Label>
      <asp:Label id="nameLabel" runat="server" 
        style="LEFT: 20px;POSITION: absolute; TOP: 87px" AssociatedControlID="userName"> 
        Name </asp:Label>
      ...
      <asp:Label id="ageLabel" runat="server"  AssociatedControlID="ageTextBox"
        style="LEFT: 23px; POSITION: absolute; TOP: 183px">Age</asp:Label>
      <asp:RangeValidator id="RangeValidator1" runat="server" ErrorMessage="RangeValidator" 
        ...
        Type="Integer" Height="19px" Width="170px" style="LEFT: 288px; POSITION: absolute; TOP: 200px"> 
        Valid age(18-100).</asp:RangeValidator>
      <asp:Button id="submitButton" runat="server" Text="Submit" OnClick="submitButton_Click" 
        style="LEFT: 123px; POSITION: absolute; TOP: 230px"></asp:Button>
      <asp:Label id="message" runat="server" Height="19px" Width="528px" Visible="False"
        Font-Size="Small" style="LEFT: 47px; POSITION: absolute; TOP: 271px">
      Validators on this page:</asp:Label>
      <asp:Label id="messageLabel" runat="server" Height="86px" Width="548px" 
        style="LEFT: 47px; POSITION: absolute; TOP: 312px"></asp:Label>
      </form>
   </body>
</html>
