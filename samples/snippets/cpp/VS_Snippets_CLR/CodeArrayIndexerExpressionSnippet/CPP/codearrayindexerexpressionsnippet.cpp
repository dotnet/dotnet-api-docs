...
private:
   ...
   void InitializeComponent()
   {
      ...
      // groupBox1
      // 
      array<System::Windows::Forms::Control^>^temp2 = {this->radioButton3,this->radioButton2,this->radioButton1};
      ...
      array<System::Windows::Forms::Control^>^temp3 = {this->groupBox1,this->button2,this->button1,this->textBox1};
