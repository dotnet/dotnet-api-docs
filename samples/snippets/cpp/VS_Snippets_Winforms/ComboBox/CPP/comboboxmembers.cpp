...
private:
   void InitializeComponent()
   {
      ...
      this->showSelectedButton->Click += gcnew System::EventHandler( this, &Win32Form1::showSelectedButton_Click );
      ...
      this->findButton->Click += gcnew System::EventHandler( this, &Win32Form1::findButton_Click );
      ...
      array<System::Windows::Forms::Control^>^ controlArray = {this->comboBox1,
         this->textBox2,
         this->textBox1,
