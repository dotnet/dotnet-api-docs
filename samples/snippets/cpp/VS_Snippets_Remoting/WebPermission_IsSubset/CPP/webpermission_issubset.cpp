...
// </Snippet1>
      ...
      WebPermission^ myWebPermission2 = gcnew WebPermission( NetworkAccess::Connect,"http://www.contoso.com" );
      // Check whether all callers higher in the call stack have been granted the permission.
      myWebPermission2->Demand();
      
// <Snippet2>
      WebPermission^ myWebPermission3 = nullptr;
...
// </Snippet2>
      ...
      // Prints the attributes, values and children of XML encoded instances.
