...
<script runat="server">
  ...
  Sub EmployeeFormView_ItemInserted(ByVal sender As Object, ByVal e As FormViewInsertedEventArgs)
    ...
    ' values.
    MessageLabel.Text = "The Values collection contains " & _
      "the following key/value pairs:<br/><br/>"
    
    ' In Visual Basic, the DictionaryItem objects contained in the 
    ' Values collection must be copied to an array before
