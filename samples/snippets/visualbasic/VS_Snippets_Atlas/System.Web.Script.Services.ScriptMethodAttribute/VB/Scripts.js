...
{
    System.Web.Script.Services.VB.WebService.GetServerTime();
...
function Add(a,  b)
{
    System.Web.Script.Services.VB.WebService.Add(a, b, 
    OnSucceeded);
}
...
{
    System.Web.Script.Services.VB.WebService.GetXmlDocument(
...
{
    System.Web.Script.Services.VB.WebService.EchoStringAndDate(
