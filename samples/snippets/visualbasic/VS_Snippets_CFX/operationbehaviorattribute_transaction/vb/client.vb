...
Namespace Microsoft.WCF.Documentation
  ...
  Public Class Client
	Public Shared Sub Main()
	  ...
	  Dim wcfClient As New BehaviorServiceClient("httpEndpoint")
	  ...
	  Using tx As New TransactionScope(TransactionScopeOption.RequiresNew, transactionOptions)
		Try
		  ...
		  Dim info As Transactions.TransactionInformation = Transactions.Transaction.Current.TransactionInformation
