...
namespace MoreEventArgsExamples
{
    ...
    public class EventArgsCreators
    {
        ...
        //<Snippet2>
        public PaintValueEventArgs CreatePaintValueEventArgs(ITypeDescriptorContext context, object value, Graphics graphics, Rectangle bounds)
        {
        ...
        //<Snippet3>
        public ToolboxComponentsCreatedEventArgs CreateToolboxComponentsCreatedEventArgs(IComponent[] components)
        {
        ...
        //<Snippet4>
        public ToolboxComponentsCreatingEventArgs CreateToolboxComponentsCreatingEventArgs(IDesignerHost host)
        {
