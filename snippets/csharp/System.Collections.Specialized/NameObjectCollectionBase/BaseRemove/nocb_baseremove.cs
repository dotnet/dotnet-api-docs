...
public class SamplesNameObjectCollectionBase
{
    ...
    public static void Main()
    {
        ...
        IDictionary d = new ListDictionary
      {
        ...
        myCol.Remove(1);
        Console.WriteLine($"After removing the element at index 1 (Count = {myCol.Count}):");
        PrintKeysAndValues(myCol);

        // Removes an element with a specific key.
        myCol.Remove("red");
        Console.WriteLine($"After removing the element with the key \"red\" (Count = {myCol.Count}):");
        PrintKeysAndValues(myCol);
    }
