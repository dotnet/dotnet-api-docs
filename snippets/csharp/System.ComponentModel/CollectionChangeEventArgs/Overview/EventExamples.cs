...
public class Form1 : Form
{
        ...
        System.Threading.ThreadExceptionEventArgs e)
    {
        ...
        messageBoxCS.Append($"Exception = {e.Exception}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Control = {e.Control}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Data = {e.Data}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"KeyState = {e.KeyState}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"X = {e.X}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Y = {e.Y}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"AllowedEffect = {e.AllowedEffect}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Effect = {e.Effect}");
        messageBoxCS.AppendLine();
    ...
    private void Control1_GiveFeedback(Object sender, GiveFeedbackEventArgs e)
    {
        ...
        messageBoxCS.Append($"Effect = {e.Effect}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"UseDefaultCursors = {e.UseDefaultCursors}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"MousePos = {e.MousePos}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Handled = {e.Handled}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"InvalidRect = {e.InvalidRect}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ClipRectangle = {e.ClipRectangle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
    ...
    private void Control1_QueryContinueDrag(Object sender, QueryContinueDragEventArgs e)
    {
        ...
        messageBoxCS.Append($"KeyState = {e.KeyState}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"EscapePressed = {e.EscapePressed}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Action = {e.Action}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"HelpNamespace = {e.HelpNamespace}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"HelpString = {e.HelpString}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"HelpKeyword = {e.HelpKeyword}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Alt = {e.Alt}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Control = {e.Control}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Handled = {e.Handled}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"KeyCode = {e.KeyCode}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"KeyValue = {e.KeyValue}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"KeyData = {e.KeyData}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Modifiers = {e.Modifiers}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Shift = {e.Shift}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"SuppressKeyPress = {e.SuppressKeyPress}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"KeyChar = {e.KeyChar}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Handled = {e.Handled}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"AffectedComponent = {e.AffectedComponent}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"AffectedControl = {e.AffectedControl}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"AffectedProperty = {e.AffectedProperty}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Button = {e.Button}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Clicks = {e.Clicks}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"X = {e.X}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Y = {e.Y}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Delta = {e.Delta}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Location = {e.Location}");
        messageBoxCS.AppendLine();
    ...
    private void Control1_PreviewKeyDown(Object sender, PreviewKeyDownEventArgs e)
    {
        ...
        messageBoxCS.Append($"Shift = {e.Shift}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"IsInputKey = {e.IsInputKey}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ShowFocus = {e.ShowFocus}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ShowKeyboard = {e.ShowKeyboard}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ChangeFocus = {e.ChangeFocus}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ChangeKeyboard = {e.ChangeKeyboard}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Changed = {e.Changed}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ScrollOrientation = {e.ScrollOrientation}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Type = {e.Type}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"NewValue = {e.NewValue}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"OldValue = {e.OldValue}");
        messageBoxCS.AppendLine();
    ...
    private void AutoCompleteStringCollection1_CollectionChanged(Object sender, CollectionChangeEventArgs e)
    {
        ...
        messageBoxCS.Append($"Action = {e.Action}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Element = {e.Element}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Binding = {e.Binding}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"BindingCompleteState = {e.BindingCompleteState}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"BindingCompleteContext = {e.BindingCompleteContext}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ErrorText = {e.ErrorText}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Exception = {e.Exception}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Value = {e.Value}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"DesiredType = {e.DesiredType}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Item = {e.Item}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ClickedItem = {e.ClickedItem}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"NewObject = {e.NewObject}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ListChangedType = {e.ListChangedType}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"NewIndex = {e.NewIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"OldIndex = {e.OldIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"PropertyDescriptor = {e.PropertyDescriptor}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ListItem = {e.ListItem}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Value = {e.Value}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"DesiredType = {e.DesiredType}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"BackColor = {e.BackColor}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Bounds = {e.Bounds}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Font = {e.Font}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ForeColor = {e.ForeColor}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Index = {e.Index}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"State = {e.State}");
        messageBoxCS.AppendLine();
    ...
    private void ListBox1_MeasureItem(Object sender, MeasureItemEventArgs e)
    {
        ...
        messageBoxCS.Append($"Index = {e.Index}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ItemHeight = {e.ItemHeight}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ItemWidth = {e.ItemWidth}");
        messageBoxCS.AppendLine();
    ...
    private void CheckedListBox1_ItemCheck(Object sender, ItemCheckEventArgs e)
    {
        ...
        messageBoxCS.Append($"NewValue = {e.NewValue}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"CurrentValue = {e.CurrentValue}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"CloseReason = {e.CloseReason}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Forward = {e.Forward}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"PreviousModes = {e.PreviousModes}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"PreviousModeAutoSized = {e.PreviousModeAutoSized}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Column = {e.Column}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"PreviousMode = {e.PreviousMode}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Response = {e.Response}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ColumnIndex = {e.ColumnIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex = {e.RowIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ContextMenuStrip = {e.ContextMenuStrip}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ColumnIndex = {e.ColumnIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex = {e.RowIndex}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"CellStyle = {e.CellStyle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ColumnIndex = {e.ColumnIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"FormattingApplied = {e.FormattingApplied}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex = {e.RowIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Value = {e.Value}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"AdvancedBorderStyle = {e.AdvancedBorderStyle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"CellBounds = {e.CellBounds}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"CellStyle = {e.CellStyle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ClipBounds = {e.ClipBounds}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ColumnIndex = {e.ColumnIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ErrorText = {e.ErrorText}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"FormattedValue = {e.FormattedValue}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"PaintParts = {e.PaintParts}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex = {e.RowIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"State = {e.State}");
    ...
    private void DataGridView1_CellParsing(Object sender, DataGridViewCellParsingEventArgs e)
    {
        ...
        messageBoxCS.Append($"ColumnIndex = {e.ColumnIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"InheritedCellStyle = {e.InheritedCellStyle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ParsingApplied = {e.ParsingApplied}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Value = {e.Value}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"DesiredType = {e.DesiredType}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Cell = {e.Cell}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"StateChanged = {e.StateChanged}");
        messageBoxCS.AppendLine();
    ...
    private void DataGridView1_CellStyleContentChanged(Object sender, DataGridViewCellStyleContentChangedEventArgs e)
    {
        ...
        messageBoxCS.Append($"CellStyle = {e.CellStyle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"CellStyleScope = {e.CellStyleScope}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ToolTipText = {e.ToolTipText}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ColumnIndex = {e.ColumnIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex = {e.RowIndex}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Context = {e.Context}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Exception = {e.Exception}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ThrowException = {e.ThrowException}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ColumnIndex = {e.ColumnIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex = {e.RowIndex}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Height = {e.Height}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"MinimumHeight = {e.MinimumHeight}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex = {e.RowIndex}");
        messageBoxCS.AppendLine();
    ...
    private void DataGridView1_RowPostPaint(Object sender, DataGridViewRowPostPaintEventArgs e)
    {
        ...
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"InheritedRowStyle = {e.InheritedRowStyle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"IsFirstDisplayedRow = {e.IsFirstDisplayedRow}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"IsLastVisibleRow = {e.IsLastVisibleRow}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowBounds = {e.RowBounds}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex = {e.RowIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"State = {e.State}");
    ...
    private void DataGridView1_RowsAdded(Object sender, DataGridViewRowsAddedEventArgs e)
    {
        ...
        messageBoxCS.Append($"RowIndex = {e.RowIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowCount = {e.RowCount}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"CellValue1 = {e.CellValue1}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"CellValue2 = {e.CellValue2}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Column = {e.Column}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex1 = {e.RowIndex1}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RowIndex2 = {e.RowIndex2}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"SortResult = {e.SortResult}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Handled = {e.Handled}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"InputLanguage = {e.InputLanguage}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Culture = {e.Culture}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"CharSet = {e.CharSet}");
        messageBoxCS.AppendLine();
    ...
    private void Form1_InputLanguageChanging(Object sender, InputLanguageChangingEventArgs e)
    {
        ...
        messageBoxCS.Append($"Culture = {e.Culture}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"SysCharSet = {e.SysCharSet}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"MouseButtonsPressed = {e.MouseButtonsPressed}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ClientMousePosition = {e.ClientMousePosition}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"OffsetMousePosition = {e.OffsetMousePosition}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"MousePosition = {e.MousePosition}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"BubbleEvent = {e.BubbleEvent}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"KeyPressedCode = {e.KeyPressedCode}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"AltKeyPressed = {e.AltKeyPressed}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"CtrlKeyPressed = {e.CtrlKeyPressed}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ShiftKeyPressed = {e.ShiftKeyPressed}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"EventType = {e.EventType}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ReturnValue = {e.ReturnValue}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"FromElement = {e.FromElement}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ToElement = {e.ToElement}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Description = {e.Description}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Handled = {e.Handled}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"LineNumber = {e.LineNumber}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Url = {e.Url}");
        messageBoxCS.AppendLine();
    ...
    private void LinkLabel1_LinkClicked(Object sender, LinkLabelLinkClickedEventArgs e)
    {
        ...
        messageBoxCS.Append($"Button = {e.Button}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Link = {e.Link}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Label = {e.Label}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Item = {e.Item}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"CancelEdit = {e.CancelEdit}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"StartIndex = {e.StartIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"EndIndex = {e.EndIndex}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"OldDisplayIndex = {e.OldDisplayIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"NewDisplayIndex = {e.NewDisplayIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Header = {e.Header}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
        messageBoxCS.AppendLine();
    ...
    private void ListView1_ColumnWidthChanging(Object sender, ColumnWidthChangingEventArgs e)
    {
        ...
        messageBoxCS.Append($"ColumnIndex = {e.ColumnIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"NewWidth = {e.NewWidth}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"DrawDefault = {e.DrawDefault}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Bounds = {e.Bounds}");
    ...
    private void ListView1_DrawItem(Object sender, DrawListViewItemEventArgs e)
    {
        ...
        messageBoxCS.Append($"Bounds = {e.Bounds}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ItemIndex = {e.ItemIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"State = {e.State}");
        messageBoxCS.AppendLine();
        MessageBox.Show(messageBoxCS.ToString(), "DrawItem Event");
    ...
    private void ListView1_DrawSubItem(Object sender, DrawListViewSubItemEventArgs e)
    {
        ...
        messageBoxCS.Append($"Item = {e.Item}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"SubItem = {e.SubItem}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ItemIndex = {e.ItemIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ColumnIndex = {e.ColumnIndex}");
        ...
        messageBoxCS.Append($"Header = {e.Header}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ItemState = {e.ItemState}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"IsSelected = {e.IsSelected}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Item = {e.Item}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ItemIndex = {e.ItemIndex}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"IsTextSearch = {e.IsTextSearch}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"IncludeSubItemsInSearch = {e.IncludeSubItemsInSearch}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Index = {e.Index}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"IsPrefixSearch = {e.IsPrefixSearch}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Text = {e.Text}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"StartingPoint = {e.StartingPoint}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Direction = {e.Direction}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"StartIndex = {e.StartIndex}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Position = {e.Position}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"RejectionHint = {e.RejectionHint}");
        messageBoxCS.AppendLine();
    ...
    private void MaskedTextBox1_TypeValidationCompleted(Object sender, TypeValidationEventArgs e)
    {
        ...
        messageBoxCS.Append($"Cancel = {e.Cancel}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"IsValidInput = {e.IsValidInput}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Message = {e.Message}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ReturnValue = {e.ReturnValue}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ValidatingType = {e.ValidatingType}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Start = {e.Start}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"End = {e.End}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Cancelled = {e.Cancelled}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Error = {e.Error}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"UserState = {e.UserState}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ProgressPercentage = {e.ProgressPercentage}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"UserState = {e.UserState}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ChangedItem = {e.ChangedItem}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"OldValue = {e.OldValue}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"OldTab = {e.OldTab}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"NewTab = {e.NewTab}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"NewSelection = {e.NewSelection}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"OldSelection = {e.OldSelection}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"NewRectangle = {e.NewRectangle}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"LinkText = {e.LinkText}");
        messageBoxCS.AppendLine();
        MessageBox.Show(messageBoxCS.ToString(), "LinkClicked Event");
    }
    //</snippet541>
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"MouseCursorX = {e.MouseCursorX}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"MouseCursorY = {e.MouseCursorY}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"SplitX = {e.SplitX}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"SplitY = {e.SplitY}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Panel = {e.Panel}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"BackColor = {e.BackColor}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Bounds = {e.Bounds}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"StatusBarPanel = {e.StatusBarPanel}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Button = {e.Button}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Clicks = {e.Clicks}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"TabPage = {e.TabPage}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"TabPageIndex = {e.TabPageIndex}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Action = {e.Action}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"ArrowRectangle = {e.ArrowRectangle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ArrowColor = {e.ArrowColor}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Direction = {e.Direction}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Graphics = {e.Graphics}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"AffectedBounds = {e.AffectedBounds}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"BackColor = {e.BackColor}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ToolStrip = {e.ToolStrip}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ConnectedArea = {e.ConnectedArea}");
        messageBoxCS.AppendLine();
    ...
    private void ToolStripRenderer1_RenderToolStripPanelBackground(Object sender, ToolStripPanelRenderEventArgs e)
    {
        ...
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ToolStripPanel = {e.ToolStripPanel}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Handled = {e.Handled}");
        messageBoxCS.AppendLine();
    ...
    private void ToolStripRenderer1_RenderToolStripContentPanelBackground(Object sender, ToolStripContentPanelRenderEventArgs e)
    {
        ...
        messageBoxCS.Append($"Handled = {e.Handled}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ToolStripContentPanel = {e.ToolStripContentPanel}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"GripBounds = {e.GripBounds}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"GripDisplayStyle = {e.GripDisplayStyle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"GripStyle = {e.GripStyle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"AffectedBounds = {e.AffectedBounds}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"BackColor = {e.BackColor}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Image = {e.Image}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ImageRectangle = {e.ImageRectangle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Item = {e.Item}");
    ...
    private void ToolStripRenderer1_RenderItemText(Object sender, ToolStripItemTextRenderEventArgs e)
    {
        ...
        messageBoxCS.Append($"Text = {e.Text}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"TextColor = {e.TextColor}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"TextFont = {e.TextFont}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"TextRectangle = {e.TextRectangle}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"TextFormat = {e.TextFormat}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"TextDirection = {e.TextDirection}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Item = {e.Item}");
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"Vertical = {e.Vertical}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Item = {e.Item}");
    ...
    private void ToolTip1_Draw(Object sender, DrawToolTipEventArgs e)
    {
        ...
        messageBoxCS.Append($"Graphics = {e.Graphics}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"AssociatedWindow = {e.AssociatedWindow}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"AssociatedControl = {e.AssociatedControl}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Bounds = {e.Bounds}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ToolTipText = {e.ToolTipText}");
    ...
    private void ToolTip1_Popup(Object sender, PopupEventArgs e)
    {
        ...
        messageBoxCS.Append($"AssociatedControl = {e.AssociatedControl}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"IsBalloon = {e.IsBalloon}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"ToolTipSize = {e.ToolTipSize}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
        messageBoxCS.AppendLine();
    ...
    private void TreeView1_BeforeLabelEdit(Object sender, NodeLabelEditEventArgs e)
    {
        ...
        messageBoxCS.Append($"Label = {e.Label}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Node = {e.Node}");
        messageBoxCS.AppendLine();
        MessageBox.Show(messageBoxCS.ToString(), "BeforeLabelEdit Event");
    }
    //</snippet624>
    ...
    private void WebBrowser1_Navigating(Object sender, WebBrowserNavigatingEventArgs e)
    {
        ...
        messageBoxCS.Append($"Url = {e.Url}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"TargetFrameName = {e.TargetFrameName}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"Cancel = {e.Cancel}");
        messageBoxCS.AppendLine();
    ...
    {
        System.Text.StringBuilder messageBoxCS = new();
        messageBoxCS.Append($"CurrentProgress = {e.CurrentProgress}");
        messageBoxCS.AppendLine();
        messageBoxCS.Append($"MaximumProgress = {e.MaximumProgress}");
        messageBoxCS.AppendLine();
