...
public partial class Territory : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	public Region Region
	{
		...
		set
		{
			...
			if (((previousValue != value)
						|| (!this._Region.HasLoadedOrAssignedValue )))
			{
				this.SendPropertyChanging();
				if ((previousValue != null))
				{
...
public partial class MultipleResultTypesSequentiallyResult1
{
	...
	public MultipleResultTypesSequentiallyResult1()
	{
	}
...
public partial class MultipleResultTypesSequentiallyResult2
{
	...
	public MultipleResultTypesSequentiallyResult2()
	{
	}
...
public partial class VariableResultShapesResult1
{
	...
	public VariableResultShapesResult1()
	{
	}
