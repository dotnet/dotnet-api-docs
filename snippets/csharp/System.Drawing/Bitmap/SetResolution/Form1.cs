    ...
    System.Windows.Forms.Form
{
    ...
    protected void DrawCaps(PaintEventArgs e)
    {
        ...
        {
            CustomStartCap = HookCap,
            CustomEndCap = HookCap
        };
    ...
    private void OpAdditionExample(PaintEventArgs e)
    {
        ...
        if (new PointF(rect1.Right, rect1.Bottom) == point1 + size1)
            e.Graphics.DrawString("They are equal", Font, Brushes.Black, rect1);
        else
            e.Graphics.DrawString("They are not equal", Font, Brushes.Red, rect1);
    }
    //</snippet5>
