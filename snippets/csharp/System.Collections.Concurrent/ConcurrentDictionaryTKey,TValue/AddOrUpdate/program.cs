...
class CD_Ctor
{
    ...
    static void Main()
    {
        ...
        ConcurrentDictionary<int, int> cd = new(concurrencyLevel, initialCapacity);
        ...
        Console.WriteLine($"The square root of 529 is {cd[23]} (should be {529 / 23})");
        Console.WriteLine($"The square of 65 is {cd[HIGHNUMBER + 1]} (should be {(HIGHNUMBER + 1) * (HIGHNUMBER + 1)})");
    }
}
//</snippet1>
