...
static class ImmutableArraySnippets
{
    static void ImmutableArrayNumbers()
    {
        ...
        // numbers2 contains: 2 3 4 -1 -2 -3
        // </SnippetModify>

        // <SnippetBuilder>
        // Create an immutable array builder.
