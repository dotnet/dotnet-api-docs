...
namespace MiscCompModSamples
{
	public class ComponentEventHandlerExample
	{
        ...
        public void LinkComponentEvent(IComponentChangeService changeService)
        {
            ...
            changeService.ComponentAdded += new ComponentEventHandler(OnComponentEvent);
            changeService.ComponentAdding += new ComponentEventHandler(OnComponentEvent);
            changeService.ComponentRemoved += new ComponentEventHandler(OnComponentEvent);
            changeService.ComponentRemoving += new ComponentEventHandler(OnComponentEvent);
        }
