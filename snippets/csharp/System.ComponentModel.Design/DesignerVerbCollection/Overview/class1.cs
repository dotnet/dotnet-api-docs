...
namespace DesignerVerbCollectionExample
{
    public class Class1
	{
        ...
        public void DesignerVerbCollectionExample()
        {
            ...
            collection.Add(new DesignerVerb("Example designer verb", ExampleEvent));
            //</Snippet3>
            ...
            DesignerVerb[] verbs =
            [
                new("Example designer verb", ExampleEvent),
                new("Example designer verb", ExampleEvent)
            ];
            ...
            verbsCollection.Add(new DesignerVerb("Example designer verb", ExampleEvent));
            verbsCollection.Add(new DesignerVerb("Example designer verb", ExampleEvent));
            ...
            DesignerVerb testVerb = new("Example designer verb", ExampleEvent);
            int itemIndex = -1;
            ...
            collection.Insert(0, new DesignerVerb("Example designer verb", ExampleEvent));
            //</Snippet8>

            //<Snippet9>
            // Removes the specified DesignerVerb from the collection.
            DesignerVerb verb = new("Example designer verb", ExampleEvent);
