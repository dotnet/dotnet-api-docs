...
namespace MiscCompModSamples
{
	public class DesignerTransactionCloseEventHandlerExample
	{
        ...
        {                       
            ...
            host.TransactionClosing += new DesignerTransactionCloseEventHandler(OnTransactionClose);
            host.TransactionClosed += new DesignerTransactionCloseEventHandler(OnTransactionClose);
        }
