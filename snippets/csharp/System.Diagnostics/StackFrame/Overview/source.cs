    ...
    class ConsoleApp
    {
        ...
        public static void Run()
        {
            ...
            catch (Exception)
            {
                ...
                StackTrace st = new(new StackFrame(true));
    ...
    public class ClassLevel3
    {
        ...
        public void Level3Method()
        {
            ...
            catch (Exception)
            {
                ...
                // line number.
                StackTrace st = new(new StackFrame("source.cs", 60));
    ...
    public class ClassLevel4
    {
        public void Level4Method()
        {
            ...
            catch (Exception)
            {
                ...
                // and column number.
                StackTrace st = new(new StackFrame("source.cs", 79, 24));
                Console.WriteLine(" Stack trace with dummy stack frame: {0}",
                               st.ToString());
