...
namespace CompilerError_Example
{
    public class Class1
    {
        ...
        static void Main()
        {
            ...
            CompilerParameters options = new(assemblies, "output.exe");
