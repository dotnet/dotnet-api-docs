...
public class SamplesStack
{
    public static void Run()
    {
        ...
        Console.WriteLine($"myStack is {(myStack.IsSynchronized ? "synchronized" : "not synchronized")}.");
        Console.WriteLine($"mySyncdStack is {(mySyncdStack.IsSynchronized ? "synchronized" : "not synchronized")}.");
    }
}
/*
