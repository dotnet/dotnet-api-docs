...
public class SamplesBitArray
{
    ...
    public static void Main()
    {
        ...
        // Creates and initializes the one-dimensional target Array of type bool.
        bool[] myBoolArray = new bool[8];
        myBoolArray[0] = false;
        myBoolArray[1] = false;

        // Displays the values of the target Array.
        Console.WriteLine("The target bool Array contains the following (before and after copying):");
        ...
        // Returns an exception if the array is not of type bool, integer or byte.
        try
        {
...
The target bool Array contains the following (before and after copying):
...
The target byte Array contains the following (before and after copying):
      10      11       0       0       0       0       0       0
      10      11       0      15       0       0       0       0
Exception: System.ArgumentException: Only supported array types for CopyTo on BitArrays are bool[], int[] and byte[].
