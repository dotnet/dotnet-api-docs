...
namespace GCGetGenerationWeakExample
{
    public class MyGCCollectClass
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine($"The object is in generation: {GC.GetGeneration(myGCCol)}");
            ...
            WeakReference wkref = new(myGCCol);
            // Remove the strong reference to myGCCol.
            myGCCol = null;

            // Get the generation of managed memory where wkref is stored.
            Console.WriteLine($"The WeakReference to the object is in generation: {GC.GetGeneration(wkref)}");
            ...
            {
                Console.WriteLine($"The WeakReference to the object has been garbage collected: '{e}'");
                Console.Read();
            }
        }
