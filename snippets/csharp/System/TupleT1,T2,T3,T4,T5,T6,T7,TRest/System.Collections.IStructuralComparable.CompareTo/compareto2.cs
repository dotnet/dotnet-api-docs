...
public class PopulationComparer<T1, T2, T3, T4, T5, T6, T7, T8> : IComparer
{
    ...
    public int Compare(object x, object y)
    {
        ...
        {
            1 => Comparer<T1>.Default.Compare(tX.Item1, tY.Item1) * multiplier,
            2 => Comparer<T2>.Default.Compare(tX.Item2, tY.Item2) * multiplier,
            3 => Comparer<T3>.Default.Compare(tX.Item3, tY.Item3) * multiplier,
            4 => Comparer<T4>.Default.Compare(tX.Item4, tY.Item4) * multiplier,
            5 => Comparer<T5>.Default.Compare(tX.Item5, tY.Item5) * multiplier,
            6 => Comparer<T6>.Default.Compare(tX.Item6, tY.Item6) * multiplier,
            7 => Comparer<T7>.Default.Compare(tX.Item7, tY.Item7) * multiplier,
            8 => Comparer<T8>.Default.Compare(tX.Rest.Item1, tY.Rest.Item1) * multiplier,
            _ => Comparer<T1>.Default.Compare(tX.Item1, tY.Item1) * multiplier
        };
    }
}
