...
public class Example
{
    public static void Main()
    {
        ...
        DateTime date1 = new(1389, 5, 27, 16, 32, 0, persian);
        ...
        DateTime date2 = new(1431, 9, 9, 16, 32, 18, hijri);
        Console.WriteLine($"{current} culture using the {GetCalendarName(hijri)} calendar: {date2:g}");

        // Restore previous culture.
        Thread.CurrentThread.CurrentCulture = dftCulture;
        Console.WriteLine($"{CultureInfo.CurrentCulture} culture using the {GetCalendarName(CultureInfo.CurrentCulture.Calendar)} calendar: {date2:g}");
    }
