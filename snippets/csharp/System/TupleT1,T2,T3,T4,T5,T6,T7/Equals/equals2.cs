...
public class Example
{
    public static void Main()
    {
        ...
        Console.WriteLine($"   {rate2} : {eq.Equals(rate2, new RateComparer<string, double, double, double, double, double, double>())}");
        Console.WriteLine($"   {rate3} : {eq.Equals(rate3, new RateComparer<string, double, double, double, double, double, double>())}");
        Console.WriteLine($"   {rate4} : {eq.Equals(rate4, new RateComparer<string, double, double, double, double, double, double>())}");
    }
}
