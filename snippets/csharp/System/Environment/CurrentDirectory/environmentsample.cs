...
public class EnvironmentSample
{
    ...
    //<Snippet3>
    static void OuterMethod() => InnerMethod();

    static void InnerMethod() => Console.WriteLine("StackTrace after calling Main()->OuterMethod()->InnerMethod():" + Environment.StackTrace);
    //</Snippet3>
}
//</Snippet1>
