...
public class Example
{
    public static void Main()
    {
        ...
        Console.WriteLine($"   Type: {tuple1Type.Name}");
        Console.WriteLine($"   Generic Parameter Type: {tuple1Type.GetGenericArguments()[0]}");
        Console.WriteLine($"   Component Value: {tuple1.Item1}");
        Console.WriteLine($"   Component Value Type: {tuple1.Item1.GetType().Name}");
        Console.WriteLine();
        ...
        Console.WriteLine($"   Type: {tuple2Type.Name}");
        Console.WriteLine($"   Generic Parameter Type: {tuple2Type.GetGenericArguments()[0]}");
        Console.WriteLine($"   Component Value: {tuple2.Item1}");
        Console.WriteLine($"   Component Value Type: {tuple2.Item1.GetType().Name}");
    }
}
