...
public class PetsHasFlagExample
{
    public static void Run()
    {
        ...
        Console.WriteLine($"{familiesWithoutPets} of {petsInFamilies.Length} families in the sample have no pets.");
        Console.WriteLine($"{familiesWithDog} of {petsInFamilies.Length} families in the sample have a dog.");
    }
}
