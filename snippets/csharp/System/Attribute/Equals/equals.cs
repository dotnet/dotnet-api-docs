...
public class ArgumentUsageAttribute : Attribute
{
    ...
    public override string ToString() => $"{base.ToString()}: {usageMsg}";
}
...
public class ArgumentIDAttribute : Attribute
{
    ...
    public ArgumentIDAttribute() => this.instanceGUID = Guid.NewGuid();

    // instanceGUID is storage for the generated GUID.
    protected Guid instanceGUID;

    // Override ToString() to append the GUID to what the base generates.
    public override string ToString() => $"{base.ToString()}.{instanceGUID.ToString()}";
}
