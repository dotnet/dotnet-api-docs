...
public class Class1
{
    ...
    private static void TryParseExact1()
    {
        ...
        if (DateTimeOffset.TryParseExact(dateString, format, provider,
                                         ...
                                         out result))
            Console.WriteLine($"'{dateString}' converts to {result.ToString()}.");
        else
    ...
    private static void TryParseExact2()
    {
        ...
        if (tries >= 3)
            Console.WriteLine($"Exiting application without parsing {input}");
        else
            Console.WriteLine($"{input} was converted to {result.ToString()}");
