...
public class Class1
{
    ...
    private static void ShowDateFormats()
    {
        ...
        DateTimeOffset thisDate = new(2008, 3, 17, 1, 32, 0, new TimeSpan(-5, 0, 0));
        ...
        fmt = "D";
        Console.WriteLine($"'{fmt}' format specifier: {thisDate.Date.ToString(fmt)}");
    ...
    private static void ConvertToDateTime()
    {
        ...
        Console.WriteLine($"{offsetDate.ToString()} converts to {regularDate}, Kind {regularDate.Kind}.");
    ...
    {
        // <Snippet3>
        DateTimeOffset startOfMonth = new(2008, 1, 1, 0, 0, 0,
                                                 DateTimeOffset.Now.Offset);
        int year = startOfMonth.Year;
        do
        {
            Console.WriteLine($"{startOfMonth:MMM d, yyyy} is a {startOfMonth.DayOfWeek}.");
        ...
        // <Snippet4>
        DateTimeOffset displayDate = new(2008, 1, 1, 13, 18, 00,
                                                        DateTimeOffset.Now.Offset);
        Console.WriteLine($"{displayDate:D}");  // Output: Tuesday, January 01, 2008
        Console.WriteLine("{0:d} is a {0:dddd}.",
                          displayDate);           // Output: 1/1/2008 is a Tuesday.
                                                  // </Snippet4>

        // <Snippet5>
        DateTimeOffset thisDate = new(2007, 6, 1, 6, 15, 0,
                                                     DateTimeOffset.Now.Offset);
    ...
    {
        // <Snippet6>
        DateTimeOffset theTime = new(2008, 3, 1, 14, 15, 00,
                                               DateTimeOffset.Now.Offset);
        Console.WriteLine($"The hour component of {theTime} is {theTime.Hour}.");

        Console.WriteLine($"The hour component of {theTime} is{theTime.ToString(" H")}.");

        Console.WriteLine($"The hour component of {theTime} is {theTime.ToString("HH")}.");
    ...
    private static void ConvertToLocalTime()
    {
        ...
        dto = new(2007, 3, 11, 3, 30, 0, new TimeSpan(-7, 0, 0));
        Console.WriteLine(dto.LocalDateTime);
        dto = new(2007, 3, 11, 2, 30, 0, new TimeSpan(-7, 0, 0));
        Console.WriteLine(dto.LocalDateTime);
        // Invalid time in local time zone
        dto = new(2007, 3, 11, 2, 30, 0, new TimeSpan(-8, 0, 0));
        ...
        dto = new(2007, 11, 4, 1, 30, 0, new TimeSpan(-7, 0, 0));
        Console.WriteLine(TimeZoneInfo.Local.IsAmbiguousTime(dto));
        Console.WriteLine(dto.LocalDateTime);
        dto = new(2007, 11, 4, 2, 30, 0, new TimeSpan(-7, 0, 0));
        Console.WriteLine(TimeZoneInfo.Local.IsAmbiguousTime(dto));
        Console.WriteLine(dto.LocalDateTime);
        // This is also an ambiguous time
        dto = new(2007, 11, 4, 1, 30, 0, new TimeSpan(-8, 0, 0));
        Console.WriteLine(TimeZoneInfo.Local.IsAmbiguousTime(dto));
        Console.WriteLine(dto.LocalDateTime);
    ...
    {
        // <Snippet8>
        DateTimeOffset theTime = new(2008, 5, 1, 10, 3, 0,
                                                   DateTimeOffset.Now.Offset);
        Console.WriteLine($"The minute component of {theTime} is {theTime.Minute}.");

        Console.WriteLine($"The minute component of {theTime} is{theTime.ToString(" m")}.");

        Console.WriteLine($"The minute component of {theTime} is {theTime.ToString("mm")}.");
        // The example produces the following output:
    ...
    {
        // <Snippet9>
        DateTimeOffset theTime = new(2008, 9, 7, 11, 25, 0,
                                               DateTimeOffset.Now.Offset);
        Console.WriteLine($"The month component of {theTime} is {theTime.Month}.");

        Console.WriteLine($"The month component of {theTime} is{theTime.ToString(" M")}.");

        Console.WriteLine($"The month component of {theTime} is {theTime.ToString("MM")}.");
        // The example produces the following output:
    ...
    {
        // <Snippet10>
        DateTimeOffset theTime = new(2007, 5, 1, 16, 35, 0,
                                                    DateTimeOffset.Now.Offset);
        Console.WriteLine($"The day component of {theTime} is {theTime.Day}.");

        Console.WriteLine($"The day component of {theTime} is{theTime.ToString(" d")}.");

        Console.WriteLine($"The day component of {theTime} is {theTime.ToString("dd")}.");
        // The example produces the following output:
    ...
    private static void ShowResolution()
    {
        ...
        do
        {
            ...
            {
                ms = dto.Millisecond;
                Console.WriteLine($"{dto.ToString("M/d/yyyy h:mm:ss")}:{ms:d3} ms. {dto.ToString("zzz")}");
                ctr++;
            }
        } while (ctr < 100);
        // </Snippet11>
    ...
    {
        // <Snippet12>
        DateTimeOffset date1 = new(2008, 3, 5, 5, 45, 35, 649,
                                        new TimeSpan(-7, 0, 0));
        Console.WriteLine($"Milliseconds value of {date1.ToString("MM/dd/yyyy hh:mm:ss.fff")} is {date1.Millisecond}.");
        // The example produces the following output:
        //
    ...
    private static void ShowLocalOffset()
    {
        ...
        Console.WriteLine($"The local time zone is {Math.Abs(localTime.Offset.Hours)} hours and {localTime.Offset.Minutes} minutes {(localTime.Offset.Hours < 0 ? "earlier" : "later")} than UTC.");
    ...
    {
        // <Snippet14>
        DateTimeOffset theTime = new(2008, 6, 12, 21, 16, 32,
                                     DateTimeOffset.Now.Offset);
        Console.WriteLine($"The second component of {theTime} is {theTime.Second}.");

        Console.WriteLine($"The second component of {theTime} is{theTime.ToString(" s")}.");

        Console.WriteLine($"The second component of {theTime} is {theTime.ToString("ss")}.");
        // The example produces the following output:
    ...
    private static void IllustrateTicks()
    {
        ...
        DateTimeOffset dto = new(
                                 ticks,
                                 DateTimeOffset.Now.Offset);
        Console.WriteLine($"There are {dto.Ticks:n0} ticks in {dto.ToString()}.");
    ...
    {
        // <Snippet16>
        DateTimeOffset currentDate = new(2008, 5, 10, 5, 32, 16,
                                              DateTimeOffset.Now.Offset);
    ...
    {
        // <Snippet17>
        DateTimeOffset offsetTime = new(2007, 11, 25, 11, 14, 00,
                                    new TimeSpan(3, 0, 0));
        Console.WriteLine($"{offsetTime.ToString()} is equivalent to {offsetTime.UtcDateTime.ToString()} {offsetTime.UtcDateTime.Kind.ToString()}");
        // The example displays the following output:
    ...
    private static void CompareUtcAndLocal()
    {
        ...
        Console.WriteLine($"Local Time:          {localTime.ToString("T")}");
        Console.WriteLine($"Difference from UTC: {localTime.Offset.ToString()}");
        Console.WriteLine($"UTC:                 {utcTime.ToString("T")}");
    ...
    {
        // <Snippet19>
        DateTimeOffset theTime = new(2008, 2, 17, 9, 0, 0,
                                     DateTimeOffset.Now.Offset);
        Console.WriteLine($"The year component of {theTime} is {theTime.Year}.");

        Console.WriteLine($"The year component of {theTime} is{theTime.ToString(" y")}.");

        Console.WriteLine($"The year component of {theTime} is {theTime.ToString("yy")}.");

        Console.WriteLine($"The year component of {theTime} is {theTime.ToString("yyyy")}.");
        // The example produces the following output:
