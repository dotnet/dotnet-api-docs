...
public class Class1
{
    ...
    {
        // <Snippet1>
        DateTimeOffset takeOff = new(2007, 6, 1, 7, 55, 0,
                                     new TimeSpan(-5, 0, 0));
    ...
    {
        // <Snippet2>
        DateTimeOffset workDay = new(2008, 3, 1, 9, 0, 0,
    ...
    private static void ShowShiftStartTimes()
    {
        ...
        DateTimeOffset startTime = new(2007, 8, 6, 0, 0, 0,
                             DateTimeOffset.Now.Offset);
    ...
    {
        // <Snippet4>
        DateTimeOffset quarterDate = new(2007, 1, 1, 0, 0, 0,
                                         DateTimeOffset.Now.Offset);
    ...
    private static void DisplayTimes()
    {
        ...
        DateTimeOffset currentTime = new(1, 1, 1, 1, 30, 0,
                                     DateTimeOffset.Now.Offset);
    ...
    private static void ShowLegalLicenseAge()
    {
        ...
        Console.WriteLine($"To possess a driver's license, you must have been born on or before {latestBirthday:d}.");
        // </Snippet6>
    }
    ...
    {
        DateTimeOffset firstTime = new(2007, 9, 1, 6, 45, 0,
                                   new TimeSpan(-7, 0, 0));

        DateTimeOffset secondTime = firstTime;
        Console.WriteLine($"{firstTime} = {secondTime}: {firstTime.Equals(secondTime)}");

        secondTime = new(2007, 9, 1, 6, 45, 0,
                         new TimeSpan(-6, 0, 0));
        Console.WriteLine($"{firstTime} = {secondTime}: {firstTime.Equals(secondTime)}");

        secondTime = new(2007, 9, 1, 8, 45, 0,
                         new TimeSpan(-5, 0, 0));
        Console.WriteLine($"{firstTime} = {secondTime}: {firstTime.Equals(secondTime)}");
    ...
    {
        // <Snippet11>
        DateTimeOffset firstTime = new(2007, 11, 15, 11, 35, 00,
                                            DateTimeOffset.Now.Offset);
        DateTimeOffset secondTime = firstTime;
        ...
        secondTime = new(firstTime.DateTime,
                     TimeSpan.FromHours(firstTime.Offset.Hours + 1));
        Console.WriteLine($"{firstTime} = {secondTime}: {DateTimeOffset.Equals(firstTime, secondTime)}");

        // value of firstTime remains unchanged
        secondTime = new(firstTime.DateTime + TimeSpan.FromHours(1),
                                        TimeSpan.FromHours(firstTime.Offset.Hours + 1));
        Console.WriteLine($"{firstTime} = {secondTime}: {DateTimeOffset.Equals(firstTime, secondTime)}");
        // The example produces the following output:
    ...
    {
        // <Snippet13>
        DateTimeOffset firstDate = new(2018, 10, 25, 18, 0, 0,
                                                      new TimeSpan(-7, 0, 0));
        DateTimeOffset secondDate = new(2018, 10, 25, 18, 0, 0,
                                                       new TimeSpan(-5, 0, 0));
        DateTimeOffset thirdDate = new(2018, 9, 28, 9, 0, 0,
                                                      new TimeSpan(-7, 0, 0));
        TimeSpan difference;
    ...
    private static void ConvertToUniversal()
    {
        ...
        localTime = new(new DateTime(2007, 6, 15, 12, 0, 0));
