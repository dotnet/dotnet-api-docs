...
public class Class1
{
    ...
    private static void ToString2()
    {
        ...
        DateTimeOffset thisDate = new(2007, 5, 1, 9, 0, 0,
                                                     TimeSpan.Zero);
    ...
    {
        // <Snippet3>
        DateTimeOffset outputDate = new(2007, 10, 31, 21, 0, 0,
                                             new TimeSpan(-8, 0, 0));
        string specifier;
        ...
        Console.WriteLine($"{specifier}: {outputDate.ToString(specifier)}");
        ...
        {
            Console.WriteLine($"{specifier}: Not supported.");
        }
    ...
    {
        // <Snippet4>
        DateTimeOffset outputDate = new(2007, 11, 1, 9, 0, 0,
                                             new TimeSpan(-7, 0, 0));
