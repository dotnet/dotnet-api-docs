...
public class Example
{
    ...
    {
        DateTimeOffset dto = new(1970, 1, 1, 0, 0, 0, TimeSpan.Zero);
        Console.WriteLine($"{dto} --> Unix Seconds: {dto.ToUnixTimeSeconds()}");

        dto = new(1969, 12, 31, 23, 59, 0, TimeSpan.Zero);
        Console.WriteLine($"{dto} --> Unix Seconds: {dto.ToUnixTimeSeconds()}");

        dto = new(1970, 1, 1, 0, 1, 0, TimeSpan.Zero);
        Console.WriteLine($"{dto} --> Unix Seconds: {dto.ToUnixTimeSeconds()}");
    }
}
...
public class DateTimeOffset2
{
    ...
    public DateTimeOffset2(DateTimeOffset dto) => this.dto = dto;
